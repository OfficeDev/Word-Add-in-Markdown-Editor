...
import {GithubService, WordService, FavoritesService, MediatorService, MarkdownService, AuthGuard, AuthorizeService} from "./shared/services";
...
export class AppComponent {
    private static launch(reason?: Office.InitializationReason) {
